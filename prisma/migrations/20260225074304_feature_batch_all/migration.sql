...
-- DropForeignKey
ALTER TABLE "Contract" DROP CONSTRAINT "Contract_attorneyProfileId_fkey";

-- DropForeignKey
ALTER TABLE "Contract" DROP CONSTRAINT "Contract_caseId_fkey";

-- DropForeignKey
ALTER TABLE "Contract" DROP CONSTRAINT "Contract_clientProfileId_fkey";

-- DropForeignKey
ALTER TABLE "Contract" DROP CONSTRAINT "Contract_engagementId_fkey";

-- DropForeignKey
ALTER TABLE "Contract" DROP CONSTRAINT "Contract_paymentOrderId_fkey";

-- DropForeignKey
ALTER TABLE "ContractAuditLog" DROP CONSTRAINT "ContractAuditLog_contractId_fkey";
